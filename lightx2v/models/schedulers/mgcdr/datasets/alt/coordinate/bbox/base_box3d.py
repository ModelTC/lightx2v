...
class BaseInstance3DBoxes(object):
    ...
    def __init__(self, tensor, box_dim=7, with_yaw=True, origin=(0.5, 0.5, 0)):
        ...
        if tensor.shape[-1] == 6:
            ...
            assert box_dim == 6
            fake_rot = tensor.new_zeros(tensor.shape[0], 1) # fake_yaw
            tensor = torch.cat((tensor, fake_rot), dim=-1) #[b,6]->[b,7]
    ...
    def overlaps(cls, boxes1, boxes2, mode="iou"):
        ...
        boxes_overlap_bev_gpu(boxes1_bev.contiguous().cuda(), boxes2_bev.contiguous().cuda(), overlaps_bev)
    ...
    def points_in_boxes_batch(self, points, boxes_override=None):
        logger.warning(
            "DeprecationWarning: points_in_boxes_batch is a " "deprecated method, please consider using " "points_in_boxes_all."
        )
