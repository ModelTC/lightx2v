...
--config_json ${lightx2v_path}/configs/cogvideox_i2v.json \
--prompt "This guy gave you a thumbs-up." \
--save_video_path ${lightx2v_path}/save_results/output_lightx2v_cogvideox_i2v.mp4
